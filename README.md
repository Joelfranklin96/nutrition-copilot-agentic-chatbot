...
It leverages **OpenAI’s Agents SDK (GPT‑4)** with **multi-agent orchestration**, **Retrieval-Augmented Generation (RAG)** via **ChromaDB**, and **real-time web search** through **Model Context Protocol (MCP)**.
...
4. Add environment variables (`OPENAI_API_KEY`, `EXA_API_KEY`, `CHAINLIT_USERNAME`, `CHAINLIT_PASSWORD`, `CHAINLIT_AUTH_SECRET`).  
