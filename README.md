...
[![Powered by Anthropic](https://img.shields.io/badge/Powered%20by-Anthropic-412991?style=for-the-badge&logo=anthropic&logoColor=white)](https://www.anthropic.com/)

**A production-ready multi-agent chatbot for personalized nutrition planning, calorie tracking, and meal pricing — powered by Anthropic’s Agents SDK (Claude).**
...
It leverages **Anthropic’s Agents SDK (Claude)** with **multi-agent orchestration**, **Retrieval-Augmented Generation (RAG)** via **ChromaDB**, and **real-time web search** through **Model Context Protocol (MCP)**.
...
#### 💰 Price Checker Agent  
Fetches real-time ingredient prices and provides cost-per-meal breakdowns.
...
|------------|-------------|
| **AI Framework** | Anthropic Agents SDK (Claude) |
| **Frontend** | Chainlit |
...
| **Libraries** | Pandas, Chainlit, Anthropic |
...
4. Add environment variables (`ANTHROPIC_API_KEY`, `EXA_API_KEY`, `CHAINLIT_USERNAME`, `CHAINLIT_PASSWORD`, `CHAINLIT_AUTH_SECRET`).  
